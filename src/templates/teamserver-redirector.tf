# ----------------------- [ Basic Instance Dets ] ----------------------- #
resource "aws_instance" "teamserver-redirector" {
    ami             = var.amis["ubuntu"]
...
# ----------------------- [ Nebula Provisions ] ----------------------- #   
    ...
    provisioner "file" {
        source = "files/teamserver-redirector-caddyfile"
...
# --------------- [ Setup Commands ] ----------------------- #
    provisioner "remote-exec" {
        ...
        "sudo sed -i 's/TEAMSERVER_DOMAIN/${var.aws_domain}/g' Caddyfile",
